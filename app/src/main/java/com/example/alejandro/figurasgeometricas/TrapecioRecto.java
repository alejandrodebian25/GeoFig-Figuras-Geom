...
public class TrapecioRecto extends AppCompatActivity {
    private double a,b,b1,h;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trapecio_recto);
    ...
    public void mostrar(View v){
        if(((a_et.getText().toString()).compareTo("")!=0) && (d_et.getText().toString()).compareTo("")!=0){
           ...
           // c=Double.parseDouble(d2_et.getText().toString());
            ...
            a_tv1.setText(area(a,b,h,b1)+"");
            p_tv2.setText(perimetro(a,b,h,b1)+"");
        }
        else{
    ...
    public String area(double a,double b,double h,double b1){
        String ar;
        double area;
        area=((b+b1)*h)/2;
        ar=(num.format(area)+"");
    ...
    public String perimetro(double a,double b,double h,double b1){
        String pe;
        double pm;
        pm=a+b+b1+h;
        pe=(num.format(pm)+"");
